...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=.85\linewidth]{NN/NN_CartPole}
  \includegraphics[width=.85\linewidth]{NN/NN_Acrobot}
  \includegraphics[width=.85\linewidth]{NN/NN_MountainCar}
  \includegraphics[width=.85\linewidth]{NN/NN_MountainCarContinuous}
  \includegraphics[width=.85\linewidth]{NN/NN_Pendulum}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.85\linewidth]{PolynomialNN/without_bias/P_CartPole.png}
  \includegraphics[width=0.85\linewidth]{PolynomialNN/without_bias/P_Acrobot.png}
  \includegraphics[width=0.85\linewidth]{PolynomialNN/without_bias/P_Acrobot.png}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=.85\linewidth]{PolynomialNN/with_bias/P_CartPole}
  \includegraphics[width=.85\linewidth]{PolynomialNN/with_bias/P_Acrobot}
  \includegraphics[width=.85\linewidth]{PolynomialNN/with_bias/P_MountainCar}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.85\linewidth]{BT/BT_CartPole}
  \includegraphics[width=0.85\linewidth]{BT/BT_Acrobot}
  \includegraphics[width=0.85\linewidth]{BT/BT_MountainCar}
  \includegraphics[width=0.85\linewidth]{BT/BT_MountainCarContinuous}
  \includegraphics[width=0.85\linewidth]{BT/BT_Pendulum}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.85\linewidth]{BT/BT_MountainCarContinuous_0-1}
...
\begin{figure}[!ht]
  \centering
\includegraphics[width=.85\linewidth]{NN/with_bias/NN_CartPole}
\includegraphics[width=.85\linewidth]{NN/with_bias/NN_Acrobot}
\includegraphics[width=.85\linewidth]{NN/with_bias/NN_MountainCar}
\includegraphics[width=.85\linewidth]{NN/with_bias/NN_MountainCarContinuous}
\includegraphics[width=.85\linewidth]{NN/with_bias/NN_Pendulum}
...
\begin{figure}[!ht]
  \centering
\includegraphics[width=.85\linewidth]{experiment_2/weights/weight_factor_3/P_CartPole_w}
\includegraphics[width=.85\linewidth]{experiment_2/weights/weight_factor_3/P_Acrobot_w}
\includegraphics[width=.85\linewidth]{experiment_2/weights/weight_factor_3/P_MountainCar_w}
\includegraphics[width=.85\linewidth]{experiment_2/weights/weight_factor_3/P_MountainCarContinuous_w}
\includegraphics[width=.85\linewidth]{experiment_2/weights/weight_factor_3/P_Pendulum_w}
...
\begin{figure}[!ht]
  \centering
\includegraphics[width=.85\linewidth]{experiment_2/weights/weight_factor_3/NN_CartPole_w}
\includegraphics[width=.85\linewidth]{experiment_2/weights/weight_factor_3/NN_Acrobot_w}
\includegraphics[width=.85\linewidth]{experiment_2/weights/weight_factor_3/NN_MountainCar_w}
\includegraphics[width=.85\linewidth]{experiment_2/weights/weight_factor_3/NN_MountainCarContinuous_w}
\includegraphics[width=.85\linewidth]{experiment_2/weights/weight_factor_3/NN_Pendulum_w}
...
\begin{figure}[!ht]
  \centering
\includegraphics[width=.85\linewidth]{experiment_2/layers/NN_CartPole_l}
\includegraphics[width=.85\linewidth]{experiment_2/layers/NN_Acrobot_l}
\includegraphics[width=.85\linewidth]{experiment_2/layers/NN_MountainCar_l}
\includegraphics[width=.85\linewidth]{experiment_2/layers/NN_MountainCarContinuous_l}
\includegraphics[width=.85\linewidth]{experiment_2/layers/NN_Pendulum_l}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=.85\linewidth]{experiment_2/neurons/NN_CartPole_n}
  \includegraphics[width=.85\linewidth]{experiment_2/neurons/NN_Acrobot_n}
  \includegraphics[width=.85\linewidth]{experiment_2/neurons/NN_MountainCar_n}
  \includegraphics[width=.85\linewidth]{experiment_2/neurons/NN_MountainCarContinous_n}
  \includegraphics[width=.85\linewidth]{experiment_2/neurons/NN_Pendulum_n}
