...
\todo[inline]{Explain more? E.g. bias, generic function approximator}
...
\todo[inline]{Include theorems? \\ Spline interpolation = polynomial interpolation?}
...
\todo[inline]{Add plots from other environments? \\ Adjust axis name in bias images}
