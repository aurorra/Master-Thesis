...
\begin{subfigure}{\textwidth}
  \centering
  \includegraphics[width=0.329\textwidth]{reproduced_plots/CartPole-v0_NN_HL_0_HU_0_histogram}
  \includegraphics[width=0.329\textwidth]{reproduced_plots/CartPole-v0_NN_HL_0_HU_0_scatter_score}
  \includegraphics[width=0.329\textwidth]{reproduced_plots/CartPole-v0_NN_HL_0_HU_0_scatter_sd}
    \caption{Results of the network architecture without hidden layers}
    \label{fig:plots_reproduced_first}
\end{subfigure}
\begin{subfigure}{\textwidth}
  \centering
  \includegraphics[width=0.329\textwidth]{reproduced_plots/CartPole-v0_NN_HL_1_HU_4_histogram}
  \includegraphics[width=0.329\textwidth]{reproduced_plots/CartPole-v0_NN_HL_1_HU_4_scatter_score}
  \includegraphics[width=0.329\textwidth]{reproduced_plots/CartPole-v0_NN_HL_1_HU_4_scatter_sd}
    \caption{Results of the network architecture with one hidden layer}
    \label{fig:plots_reproduced_second}
\end{subfigure}
\begin{subfigure}{\textwidth}
  \centering
  \includegraphics[width=0.329\textwidth]{reproduced_plots/CartPole-v0_NN_HL_2_HU_4_histogram}
  \includegraphics[width=0.329\textwidth]{reproduced_plots/CartPole-v0_NN_HL_2_HU_4_scatter_score}
  \includegraphics[width=0.329\textwidth]{reproduced_plots/CartPole-v0_NN_HL_2_HU_4_scatter_sd}
