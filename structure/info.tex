...
\cosupervisor{Dr. Giuseppe Cuccu} % If you have a co-supervisor, include it here. This is used in the title page, print it elsewhere with \supname
...
\keywords{Black-Box Optimization, Reinforcement Learning, Fourier} % Keywords for your thesis, this is not currently used anywhere in the template, print it elsewhere with \keywordnames
