...
\thesistitle{Non-Differentiable Function Approximation: Beyond Neural Networks} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\keywords{black-box optimization, reinforcement learning, binary trees, neural networks, random weight guessing} % Keywords for your thesis, this is not currently used anywhere in the template, print it elsewhere with \keywordnames
